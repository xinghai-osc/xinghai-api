...
type Model struct {
	...
	RegistrationNo string         `json:"registration_no,omitempty" gorm:"type:varchar(128)"`
	LicenseNo      string         `json:"license_no,omitempty" gorm:"type:varchar(128)"`
...
func (mi *Model) Update() error {
	...
	return DB.Model(&Model{}).Where("id = ?", mi.Id).
		Select("model_name", "description", "icon", "tags", "vendor_id", "endpoints", "status", "sync_official", "registration_no", "license_no", "name_rule", "updated_time").
		Updates(mi).Error
}
