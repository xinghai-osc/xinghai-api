      ...
      <div className='mx-auto grid max-w-6xl grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-8'>
        ...
        <div className='flex flex-col items-start text-left lg:col-span-6'>
          ...
          >
            ...
            <br />
            <span className='bg-gradient-to-r from-blue-500 via-violet-500 to-purple-600 bg-clip-text text-transparent dark:from-blue-400 dark:via-violet-400 dark:to-purple-500'>
          ...
          >
            ...
            <div className='flex flex-wrap items-center gap-3'>
              ...
              {/* "更多" */}
              <div className='group border-border/40 bg-card/60 text-foreground/55 hover:border-primary/30 hover:bg-card/80 hover:text-foreground flex cursor-default items-center gap-2.5 rounded-full border px-5 py-2.5 text-sm font-medium shadow-xs backdrop-blur-sm transition-all duration-300'>
                <MoreIcon />
