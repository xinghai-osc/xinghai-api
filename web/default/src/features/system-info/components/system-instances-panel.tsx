...
type SystemInstancesTableProps = {
  ...
  onDeleteInstance: (nodeName: string) => void
                ...
                <TableCell className='py-2.5 pr-4 text-right align-middle'>
                  <div className='flex justify-end gap-1'>
                    ...
                    <Button
                      ...
                      disabled={props.deletingNodeName === instance.node_name}
                      onClick={() => props.onDeleteInstance(instance.node_name)}
...
export function SystemInstancesPanel() {
  ...
  const deleteMutation = useMutation({
    ...
    onError: (error) => {
      toast.error(
        error instanceof Error ? error.message : t('Failed to delete instance.')
      )
    },
    onSettled: () => {
    ...
    instancesContent = (
      <div className='p-4 sm:p-5'>
        <SystemInstancesList
          ...
          onDeleteInstance={(nodeName) => deleteMutation.mutate(nodeName)}
