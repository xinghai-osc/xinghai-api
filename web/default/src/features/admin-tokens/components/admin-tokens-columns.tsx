...
export function useAdminTokensColumns(): ColumnDef<AdminApiKey>[] {
  ...
  return [
    ...
    },
    {
      ...
      accessorKey: 'key',
      header: t('API Key'),
      cell: ({ row }) => <AdminApiKeyCell apiKey={row.original} />,
      enableSorting: false,
      size: 260,
    },
    {
    ...
    },
    {
      ...
      header: t('Models'),
      cell: ({ row }) => <AdminModelLimitsCell apiKey={row.original} />,
      enableSorting: false,
      size: 160,
      meta: { mobileHidden: true },
    },
    {
      ...
      cell: ({ row }) => <AdminIpRestrictionsCell apiKey={row.original} />,
      enableSorting: false,
      size: 160,
      meta: { mobileHidden: true },
    },
