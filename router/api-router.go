...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/email/test", middleware.AdminAuth(), controller.SendTestEmail)
		...
		perfMetricsAdminRoute := apiRouter.Group("/perf-metrics")
		perfMetricsAdminRoute.Use(middleware.RootAuth())
		{
			perfMetricsAdminRoute.DELETE("/failures", controller.DeletePerfMetricFailures)
		}
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/setting", controller.GetUserSettingByAdmin)
				adminRoute.PUT("/:id/setting", controller.UpdateUserSettingByAdmin)
				adminRoute.POST("/", controller.CreateUser)
				adminRoute.POST("/manage", controller.ManageUser)
				adminRoute.PUT("/", controller.UpdateUser)
				adminRoute.PUT("/aff_code", controller.UpdateUserAffCode)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.GET("/upgrade/quote", controller.SubscriptionRequestUpgradeQuote)
			subscriptionRoute.POST("/upgrade", middleware.CriticalRateLimit(), controller.SubscriptionRequestUpgrade)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.POST("/plans/:id/subscriptions/extend", controller.AdminExtendPlanSubscriptions)

			// User subscription management (admin)
			subscriptionAdminRoute.GET("/users/:id/subscriptions", controller.AdminListUserSubscriptions)
			subscriptionAdminRoute.POST("/users/:id/subscriptions", controller.AdminCreateUserSubscription)
			subscriptionAdminRoute.PUT("/user_subscriptions/:id/period", controller.AdminUpdateUserSubscriptionPeriod)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.DELETE("/channel_affinity_cache/key", controller.DeleteChannelAffinityCacheByKey)
			optionRoute.POST("/rest_model_ratio", controller.ResetModelRatio)
			optionRoute.GET("/unpriced_models", controller.GetUnpricedModels)
		...
		// Admin token management (cross-user, for viewing user-created keys)
		...
		logRoute.POST("/batch/delete", middleware.AdminAuth(), controller.DeleteLogs)
		...
		systemInfoRoute.Use(middleware.RootAuth())
		{
			...
			systemInfoRoute.DELETE("/stale-instances/:node_name", controller.DeleteStaleSystemInstance)
		}
